...
def parse_args() -> Namespace:
    ...
    p.add_argument("--num_eval_examples", type=int, default=-1, help="The number of test examples to use, use all examples in default.")  # noqa
    ...
    p.add_argument("--topk_dims_file_path", type=str, default="LWM-Text-Chat-1M_topk_dim_w200.json")
    p.add_argument("--attn_type", type=str, choices=["vllm", "hf", "streaming", "inf_llm", 'snap_kv', 'flash_attn', 'minference', 'dilated1', 'dilated2', 'minference_with_snapkv', 'minference_wo_cache'], default="hf")
